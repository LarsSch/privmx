...
class UpdateError {
  ...
  const ERROR_ALREADY_UPDATED = 'ERROR_ALREADY_UPDATED';
  const ERROR_COPY_CUSTOM_MENU = 'ERROR_COPY_CUSTOM_MENU';
  const ERROR_READ_PACK_JSON = 'ERROR_READ_PACK_JSON';
  const ERROR_WRITE_PACK_JSON = 'ERROR_WRITE_PACK_JSON';
  const ERROR_COPY_PLUGINS = 'ERROR_COPY_PLUGINS';
